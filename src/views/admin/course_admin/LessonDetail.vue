  ...
  <v-app>
    <v-container height="auto">
      <router-link
        ...
        :to="'..'"
      >
        <h2 class="text-lg">Course Name</h2>
      </router-link>
      <v-card
        :elevation="0"
        class="mx-auto"
...
export default {
  ...
  data: () => ({
    ...
    dialog1: false,
    selectedFile: null,
    imgsrc: "http://localhost/LMS/Class_service/Class_api/public/uploads/img/",
    imgsrc_path:
      "http://localhost/LMS/Class_service/Class_api/public/uploads/img/",
    lesson: null,
    description: "",
    imagePath: "",
    course_id: 1,
  ...
  methods: {
    async loadData() {
      let strUrl = apiUrl.lesson + this.$route.params.id;
      let method = "get";
      axios({
        method: method,
        url: strUrl,
