...
import { templateRendering, hasListener, getListeners, getTemplate, getDefaultSlots } from '@progress/kendo-vue-common';
import { tableColumnsVirtualization } from '@progress/kendo-vue-data-tools';
...
var Grid = {
  ...
  render: function render(createElement) {
    ...
    var data = [];
    var resolvedGroupsCount = flatData(data, gridData, groupingFooter, {
    ...
    noRecords.length ? noRecords : h(GridNoRecords)])]); // @ts-ignore

    var pager = this.$props.pageable && h(Pager, {
